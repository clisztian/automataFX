...
public class Fire extends Canvas {
    ...
    private final Image           IMAGE;//           = new Image(Fire.class.getResourceAsStream("images/fire.png"));
    private final double          HALF_WIDTH;//      = IMAGE.getWidth() * 0.5;
    private final double          HALF_HEIGHT;//     = IMAGE.getHeight() * 0.5;
    ...
    public Fire() {
    	...
    	IMAGE = new Image(getClass().getClassLoader().getResourceAsStream("images/fire.png")); 
    	HALF_WIDTH      = IMAGE.getWidth() * 0.5;
    	HALF_HEIGHT 	= IMAGE.getHeight() * 0.5;
        running          = false;
